								...
								function() {
									...
									request
											.execute(function(response) {
												document
														.getElementById('firstname').value = response['name'].familyName;
												document
														.getElementById('lastname').value = response['name'].givenName;
												...
												document
														.getElementById('datetime').value = response['birthday'];
												document
														.getElementById('password').value = 'Google';
												window.location.href = 'GoogleServlet';
											});
								});
			} else {
...
<script>
	...
	function statusChangeCallback(response) {
		...
		if (response.status === 'connected') {
			...
			// window.location.href = 'FacebookServlet';
...
<body>
	...
	<div id="wrapper">
		...
		<div id="sidebar">
			...
			<h3 id="welcome">
				Welcome Guest.<br>
				<br>Invalid registration,your email is already used. Register
				Again
			</h3>
				...
				<form action="RegisterServlet" id="registerform" name="registerform"
					...
					<div class="txtfield">
						<span id="icons" class="fa fa-user"></span> <input type="text"
							id="firstname" name="firstname" placeholder="სახელი"
							class="textfield" tabindex="1"></input>
					</div>
					<div class="txtfield">
						<span id="icons" class="fa fa-users"></span> <input type="text"
							id="lastname" name="lastname" placeholder="გვარი"
					...
					<div class="txtfield">
						<span id="icons" class="fa fa-calendar"></span> <input
							...
							placeholder="დაბადების თარიღი" class="textfield" tabindex="4"></input>
					</div>
					...
					<div class="txtfield">
						<span id="icons" class="fa fa-lock"></span> <input type="password"
							id="password" name="password" placeholder="პაროლი"
							class="textfield" tabindex="7"></input>
					</div>
					<input type="submit" name="registerbtn" id="registerbtn"
						class="flatbtn-blu hidemodal" value="რეგისტრაცია" tabindex="8"
				...
				<ul class="share">
					<div style="float: left;">
						<fb:login-button scope="public_profile,email,user_birthday"
							onlogin="checkLoginState();" size="large">
						</fb:login-button>
					</div>
					<br>
					<br>
					<div style="float: left; margin-left: 5px;" id="signin-button"
						class="show">
