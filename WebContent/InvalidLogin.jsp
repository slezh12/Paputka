...
<body>   
    ...
    <div id="wrapper">
        ...
        <div id="sidebar">
            ...
            <h3 id="welcome"> Welcome Guest.<br> <br> Invalid Login. Try Again </h3>
            ...
            <div class="sidebox">
                <ul class="share">
                        ...
                        <a href="#" onclick="fb_login();"><img src="style/images/fb.png" border="0" alt=""></a>
                        </div>
                        <br><br>
                        <div style="float:left; cursor: pointer; margin-top:10px;" id="gSignInWrapper">
